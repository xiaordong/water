...
Page({
  data: {
    ...
    last_time:'',
    core: [
      { id: 'cx', name: '学生管理', disabled: false, teacher_disabled: true },
      { id: 'fb', name: '发布消息', disabled: false, teacher_disabled: true },
      { id: 'information', name: '报修申请', disabled: false, teacher_disabled: false },
      { id: 'dj', name: '账户冻结', disabled: false, teacher_disabled: false }
    ],
